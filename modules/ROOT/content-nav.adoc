...
** xref:life-sciences/medical-care/index.adoc[]
*** xref:life-sciences/medical-care/patient-journey.adoc[]
...
* xref:cybersecurity/index.adoc[]
** xref:cybersecurity/vulnerability-prioritization-exposure-management.adoc[Vulnerability Prioritization & Exposure Management]
** xref:cybersecurity/attack-path-analysis.adoc[Attack Path Analysis]
** xref:cybersecurity/software-supply-chain-security.adoc[Software Supply Chain Security]
