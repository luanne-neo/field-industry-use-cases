...
** `openeDate` (DateTime): Optional: Date and time when the account was first opened
...
CREATE (a:Account:Internal {
    ...
    accountType: "CURRENT", 
    openeDate: datetime("2024-01-01T00:00:00"),
    closedDate: null,
    suspendedDate: null
})
...
CREATE (a3:Account:Internal:Flagged {
    ...
    accountType: "CURRENT",
    openeDate: datetime("2023-06-15T00:00:00"),
    closedDate: null,
    suspendedDate: null
})
