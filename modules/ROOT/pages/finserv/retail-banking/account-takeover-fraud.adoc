...
CREATE (originalEmail:Email {address: "john@example.com", domain: "example.com", createdAt: datetime("2024-01-01T00:00:00")})
...
CREATE (newEmail:Email {address: "attacker.new@protonmail.com", domain: "protonmail.com", createdAt: datetime("2024-03-01T14:37:00")})
